...
for n = 1:nUniqueConstSVFreq
   ...
   figure(n),
     ...
     fileNameMATLAB = "Figure %d %s.fig";
     fileNameImage = "Figure %d %s.png";
     saveas(gcf,sprintf(fileNameMATLAB, n, datestrtest))
     saveas(gcf,sprintf(fileNameImage, n, datestrtest))
